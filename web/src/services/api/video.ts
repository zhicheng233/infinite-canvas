...
import { customVideoRequiredMediaErrors, normalizeCustomVideoRuntimeState, type CustomVideoRuntimeInput, type CustomVideoRuntimeSnapshot } from "@/lib/custom-video-runtime";
...
type RequestOptions = { readonly signal?: AbortSignal; readonly customVideoRuntime?: CustomVideoRuntimeInput };
...
async function createCustomVideoTask(config: AiConfig, model: string, prompt: string, runtime: CustomVideoRuntimeInput | undefined, options?: RequestOptions): Promise<VideoGenerationTask> {
