...
export function createDefaultCustomVideoConfig(): CustomVideoConfig {
    return {
        ...
        images: { enabled: false, required: false, key: customVideoDefaultKeys.images, max_count: 1 },
        input_reference: { enabled: false, required: false, key: customVideoDefaultKeys.input_reference, max_count: 1 },
        style_references: { enabled: false, required: false, key: customVideoDefaultKeys.style_references, max_count: 1 },
        element_references: { enabled: false, required: false, key: customVideoDefaultKeys.element_references, max_count: 1 },
        reference_images: { enabled: false, required: false, key: customVideoDefaultKeys.reference_images, max_count: 1 },
        reference_mode: { enabled: false, key: customVideoDefaultKeys.reference_mode, options: [], default: "" },
        input_video: { enabled: false, required: false, key: customVideoDefaultKeys.input_video, max_count: 1 },
...
export function summarizeCustomVideoConfig(config: CustomVideoConfig): CustomVideoConfigSummary {
    ...
    return {
        ...
        media_required: Object.fromEntries(enabledCustomVideoMediaFeatures(config).map((name) => [name, config[name].required])),
