...
type TenantApiConfig struct {
	...
	ModelVideoDurations string `gorm:"type:longtext" json:"model_video_durations"`
	ModelVideoCustomizable string `gorm:"type:longtext" json:"model_video_customizable"`
}
